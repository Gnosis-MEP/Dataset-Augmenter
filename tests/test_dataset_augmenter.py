...
class TestDatasetAugmenter(MockedEventDrivenServiceStreamTestCase):
    ...
    MOCKED_STREAMS_DICT = {
        SERVICE_STREAM_KEY: [],
        'cg-DatasetAugmenter': MOCKED_CG_STREAM_DICT,
    }

    @patch('dataset_augmenter.service.DatasetAugmenter.process_event_type')
